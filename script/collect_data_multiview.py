...
Usage:
  python script/collect_multiview.py place_can_basket_single demo_clean_side \\
      --n_views 30 --episodes_per_view 10 \\
...
def main():
    ...
    print(f"Sampled {parsed.n_views} viewpoints from {len(all_cam_configs)} candidates.")
    ...
    seed_args["data_type"]["observer_camera"] = False
    ...
    for view_idx, cam_cfg in enumerate(selected_cams):
        ...
        print(f"\n--- View {view_idx+1}/{parsed.n_views}  "
